...
ARG DEMO_EXPERIMENTAL_INSTRUMENTATION_REPLAY_PATH
...
COPY ${DEMO_EXPERIMENTAL_INSTRUMENTATION_REPLAY_PATH}/package.json \
     ${DEMO_EXPERIMENTAL_INSTRUMENTATION_REPLAY_PATH}/rollup.config.js \
     ${DEMO_EXPERIMENTAL_INSTRUMENTATION_REPLAY_PATH}/tsconfig.bundle.json \
     ${DEMO_EXPERIMENTAL_INSTRUMENTATION_REPLAY_PATH}/tsconfig.cjs.json \
     ${DEMO_EXPERIMENTAL_INSTRUMENTATION_REPLAY_PATH}/tsconfig.esm.json \
     ${DEMO_EXPERIMENTAL_INSTRUMENTATION_REPLAY_PATH}/tsconfig.spec.json \
     ${DEMO_EXPERIMENTAL_INSTRUMENTATION_REPLAY_PATH}/tsconfig.json \
     ${DEMO_EXPERIMENTAL_INSTRUMENTATION_REPLAY_PATH}/

RUN mkdir -p ${DEMO_EXPERIMENTAL_INSTRUMENTATION_REPLAY_PATH}/src
RUN cp index.ts ${DEMO_EXPERIMENTAL_INSTRUMENTATION_REPLAY_PATH}/src
...
COPY ${DEMO_EXPERIMENTAL_INSTRUMENTATION_REPLAY_PATH} \
     ${DEMO_EXPERIMENTAL_INSTRUMENTATION_REPLAY_PATH}/
