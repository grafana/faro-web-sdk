...
| ------------------ | ------------------------------------------------- | ----------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `sanitizeMetaHref` | `boolean`                                         | `true`                  | Strip credentials, query string, and fragment from `window.location.href` in rrweb Meta events before sending. Faro `meta.page.url` is sanitized separately by core; arbitrary URLs may still appear in DOM snapshots |
